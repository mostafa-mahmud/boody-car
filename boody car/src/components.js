...
{/*nav*/}
			<nav>
				<div className="container">
					<a href="ss"><img alt="ss" src="https://lh3.google.com/u/0/d/1NvM8yaMfUQjM0Nu1fpE7e812Qj_DK0hK=w1366-h626-iv1"/></a>
					<ul>
		...
		<footer>
			<div className="first">
				<div className="container">
					<div>
						<div>
							<img alt="ss" src="https://lh3.google.com/u/0/d/1NvM8yaMfUQjM0Nu1fpE7e812Qj_DK0hK=w1366-h626-iv1"/>
						</div>
						<div>
							<aside>
								<h5>Company</h5>
